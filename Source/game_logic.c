...
/* Permet de renvoyer un tableau d'entier indiquant les lignes vides soit une lines remplie de 0 */
int *empty_lines(plateau *p, int *size){
    int i, j, if_empty, x = 0;
    int *empty_tab;

    /* On alloue la longueur du tableau avec la size max possible soit le nombre de lignes du plateau */
